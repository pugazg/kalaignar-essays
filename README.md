...
- Tamil source/archive workflow: [`ESSAY_PROCESSING_GUIDE.md`](ESSAY_PROCESSING_GUIDE.md)
- English translation workflow: [`ESSAY_TRANSLATION_GUIDE.md`](ESSAY_TRANSLATION_GUIDE.md)
- Single authoritative project handover: [`HANDOVER.md`](HANDOVER.md)
