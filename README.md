...
கலைஞர் மு. கருணாநிதியின் கட்டுரைகள், தொடர்கட்டுரைகள், சிறுநூல்கள் மற்றும் தொடர்புடைய source-first archival publications-ஐ Markdown வடிவில் பாதுகாக்கும் களஞ்சியம்.

> **மூல ஸ்கேன் தான் controlling source. Markdown ஒரு பாதுகாப்பு அடுக்கு; திருத்தப்பட்ட புதிய பதிப்பு அல்ல.**

Permanent workflow: `ESSAY_PROCESSING_GUIDE.md`, `HISTORICAL_TAMIL_GLYPH_TRANSCRIPTION_GUIDE.md`, `ESSAY_TRANSLATION_GUIDE.md`, root `HANDOVER.md`, `docs/FUTURE_WORK_GUIDELINES.md`, `docs/NEXT_CHAT_PROMPT.md`.
...
Exact next activity: **inspect the actual uploaded PDF bytes directly—not the preview—verify structural page count and SHA-256; raw size is already confirmed as 282020019 bytes. Close P0 only after those pass, then begin canonical P1.**
