...
Structural authority: scans **3–82 = printed pp.1–80**; source-numbered sections **1–19**; shared mid-page transitions `12,16,22,27,31,34,38,51,55,67,70,79`.
...
### Section 4 — VERIFIED / T0–T5 COMPLETE
...
- final T5 verified blob — **`9a236986ecf612f0da8de3179c8d8acd9eac3183`**;
- `translation_status` — **verified**;
...
Section 4 non-regression points:

- `சொற் பஞ்சம்` → **famine of words**;
- `குடந்தை` → **Kudanthai**; `குடந்தைப் பெரியவர்` framing retained;
- **Arignar Anna** remains source-bearing;
- Annamalai / Annadurai / Neelamegam wordplay retains `malai—mountain`, `durai—a lord`, and `megam—cloud`;
- `சபாஷ்` → **Sabash**;
- pages **25 / 26 / 27** remain exact in K. K. Neelamegam’s anecdote;
- sea-sluice and inseparable-merging imagery remain intact;
- `Ayya!`, `Annathurai kachcheri`, repeated `kachcheri`, and `Namaskaaranga!` remain source-bearing;
- source `திருச்சி சிறை` → **Trichy prison**, not expanded `Tiruchirappalli prison`;
...
### Sections 10–14 — VERIFIED / T0–T5 COMPLETE
...
Sections 10–14 non-regression points:

- Section 10: preserve Tamil sound classes/letters where the pronunciation contrast is the content; source `திருவல்லுவர்` remains visibly mispronounced; `Tamish`, `kollungal`, `ழ`, and `Senthamizh` treatment remains source-bearing;
- Section 11: **Tamil-thendral Thiru. Vi. Ka.**, **Nanjilar**, **Thanjai**, source-bearing **kathaalai tubers**, **Aasai Thambi**, Addison's `I conceive` wordplay, and Disraeli passage remain based only on the frozen Tamil;
- Section 12: Valluvar's board/dice image, `arasu tree`, `Mooladhanam (Capital)`, **Revolutionary Poet**, Jeeva's quarter-stomach image, and the Caesar/Brutus/Socrates/Shakespeare/Lincoln audience example remain intact;
