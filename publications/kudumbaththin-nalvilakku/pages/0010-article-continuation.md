...
- Post-P2 comparison/user review corrected the earlier old-glyph misreadings `பதினறு` → `பதினாறு` (twice), along with the associated inflectional readings on this page.
