...
User-supplied description compares anti-dominance resistance to a mother cow chasing away a tiger that attacked its calf, and presents the work as an argument for smaller nations daring to resist domination. Preserve that as catalog context unless the same formulation is separately verified from the source.
...
- historical Tamil typeforms — **present / mandatory historical-glyph workflow**
- source PDF committed — **No**
...
This 1953 source uses older Tamil metal-type forms. Before P2, read and apply repository root `HISTORICAL_TAMIL_GLYPH_TRANSCRIPTION_GUIDE.md`.
...
- scan 43 — **`சொல்லப்போகிறது`** → source meaningful spacing **`சொல்லப் போகிறது`**
- scan 46 — **`முடிந்துவிடக் கூடியதல்லவே`** → source meaningful spacing **`முடிந்து விடக் கூடியதல்லவே`**
