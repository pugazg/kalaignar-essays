...
article: "vengaiyai-virattum-padalam"
section: "vengaiyai-virattum-padalam"
page_type: "introductory-verse"
status: "verified"
language: "ta"
...
- source-visible section numeral **II** centered at top.
- final word fragment **யானை** continues directly onto scan 6 as **யின்**; the page boundary is preserved rather than silently joining it here.
- visible Arabic folio இல்லை.

## அச்சு அல்லாத / physical-copy marks

- ageing / faint spotting only.

## Historical glyph audit

- page checked word-by-word and against the mandatory historical-glyph families.
- **நம்புகிறான்** decoded from historical `றா` identity.
- **என்றால்** and other sensitive clusters were checked from source pixels, not lexical expectation.
