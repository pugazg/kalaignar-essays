# மூலப் பதிவு — வேதனைச் சிறையினின்றும் விடுதலை பெற

## Source identity

- Source ID / filename stem: `TVA_BOK_0064064`
- Source filename: `TVA_BOK_0064064_வேதனைச்_சிறையினின்றும்_விடுதலை_பெற.pdf`
- Source PDF committed to repository: **No**
- SHA-256: `d6429304ca8e53324e41fbe6695a31d1411b12ec5e04bf5a35d8cc8a51d06651`
- File size: **11,408,976 bytes**
- Physical scans: **8**
- Parsed/OCR text layer: **none**; this is an image-only PDF
- Language/script: Tamil
- Publication type: **single-text government public-message pamphlet**
...
- printer line: `மாநில குடும்பநலத் திட்ட அச்சகம், சென்னை-6.`

No separate edition statement, printed price, or stand-alone publication date is visible in the supplied eight scans.

## Source-described occasion / date discipline

Printed p.7 carries a bracketed source note identifying the text as a **`செய்தி`** issued to the people by Tamil Nadu Chief Minister Kalaignar M. Karunanidhi during the `குடும்ப நலத்திட்ட இருவார விழா` that **began on 15 December 1975**.
...
- exact title / source ID in `pugazg/kalaignar-essays`: **no existing work found**;
- exact title / source ID in `pugazg/kalaignar-public-speeches`: **no existing work found**.

## Physical scan / typography condition

- aged and stained paper throughout;
