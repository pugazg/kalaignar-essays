...
- மெல்லிய reverse-side show-through / பழைமை உள்ளது; body text மற்றும் bracketed source note வாசிக்கத்தக்கவையாக உள்ளன.

## P2 audit note

- bracketed note is printed source matter, not a second article and not part of the Chief Minister's message body itself.
