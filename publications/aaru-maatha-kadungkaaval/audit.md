...
| Scan | Printed folio | Record | Status | Open issue |
|---:|:---:|---|---|---|
| 46 | 43 | `0046-murasu.md` | verified | none |
| 47 | 44 | `0047-murasu.md` | verified | none |
| 48 | 45 | `0048-murasu.md` | verified | none |
| 49 | 46 | `0049-murasu.md` | verified | none |
| 50 | 47 | `0050-murasu.md` | verified | none |
...
- new unresolved printed-text holds — **0**
- cumulative historical-glyph corrections — **1**
- scan 45 `காய` → scan 46 `வதேன்` was source-resolved as `காய்வதேன்`; same-line `பாய்வதேன்` was used as a glyph comparison, not as contextual substitution.
- source-visible unusual wording/spacing was preserved without context correction.
...
- new unresolved printed-text holds — **0**
- cumulative historical-glyph corrections — **1**
- post-batch enlarged-pixel recheck corrected source readings in scans 96–100; this does **not** change the batch status totals or open-hold count.
...
- scan 98 corrected source readings include `பெண்ணாகவா`, `வாழ்க்கைக்குத் துணை`, `தொடமுடியும்`, `கிடைக்கிற இரவும்`, `கற்பனையூறுகிறது`, `கலவி நடுப்பாதையிலே`, and `வர்ணித்த`.
- scan 99 corrected source readings include `வியாபாரத்துக்குப்போன மகனே`, `தலை சுழல சுழல`, and `வைத்தாலென்னால்`.
...
- scan 152 `சூறாவளி` was decoded from historical `றா` identity as the first canonical reading; no historical correction event is counted because there was no prior competing transcription.
- unusual source-visible forms including `செங்கோ வேந்திகள்`, `குதாக்கள்`, `கள்ளிக்காடுகளா இருந்து`, `மாகாண மெங்குமுள்ள`, `சிறைச்சாலைகட்கும்`, `உத்திரவிடுவார்கள்`, and `ஏற்றங்களே` were preserved without normalization.
- page-boundary continuity was preserved: scan 154 ends `மண்வெட்டி கொண்டு`; scan 155 begins `விரைவில் செதுக்கியும்விடலாம்.`; scan 155 ends `கடுங்காவல்`.
...
- scan 174's former `பகவத் சிரோ…` uncertainty was resolved directly as `பகவத் சிரோமணிகளே!`.
- scan 174 closing `ஆனால் கிளிஞ்சல்களை வாரி இறைக்காதே!` and scan 175 `கால் மூன்றத்துக் கத்திரிக்காய்` were source-confirmed.
...
- historical-glyph correction-event count — **unchanged at 11**
- mandatory 13-family historical-glyph audit completed on all five pages.
- scan 178 historical `னா` in `வியனார்டோ` and `லை` in `கலை` / `பூஞ்சோலை` were decoded directly as first canonical readings, not corrections.
- scan 179 and 180 unusual source spellings and spacing were preserved without contextual normalization.
...
| Scan | Result | Re-audit finding |
|---:|---|---|
| 31 | PASS | complete text / heading / spacing / terminal-fragment review; no correction |
| 32 | PASS | cross-page `சுறு` + `சுறுப்புக்கும்` boundary and full text confirmed |
| 33 | PASS after correction | `வால்களையும்` → `வாள்களையும்` from enlarged source glyph identity |
| 34 | PASS after correction | `காட்டிவிட்டார்` → source-visible `காட்டி விட்டார்` |
| 35 | PASS | complete text / heading / spacing / boundary review; no correction |
...
P2R progress — **35/224**. P2 remains **222 verified / 2 needs-review**. Next range — **36–40**.

### Batch R08 — scans 36–40

| Scan | Result | Re-audit finding |
|---:|---|---|
| 36 | PASS | complete text / quotation / spacing / boundary review; no correction |
| 37 | PASS | complete text / spacing / physical splits confirmed; no correction |
| 38 | PASS | complete text / quotation / punctuation / boundary review; no correction |
...
| Scan | Result | Re-audit finding |
|---:|---|---|
| 41 | PASS | complete text / punctuation / spacing / boundary review; no correction |
| 42 | PASS after correction | `தொழிற்கல்வி` → source-visible `தொழிற் கல்வி` |
| 43 | PASS after correction | `கூறினால் - அவர்களும்` → source-visible `கூறினால்-அவர்களும்` |
| 44 | PASS | complete text / numerals / quotation / spacing / boundary review; no correction |
| 45 | PASS | complete text / punctuation / physical terminal fragment review; no correction |

Historical-family verification added **0 new correction events**; cumulative count remains **11**. Ordinary source-fidelity corrections — **2**.

P2R progress — **45/224**. P2 remains **222 verified / 2 needs-review**. Next range — **46–50**.

### Batch R10 — scans 46–50

| Scan | Result | Re-audit finding |
|---:|---|---|
| 46 | PASS | complete text / quotation / punctuation / spacing / boundary review; no correction |
| 47 | PASS | complete text / unusual source wording / boundary review; no correction |
| 48 | PASS | source-distinct `கத்தரிக் கோல்` / `கத்திரிக்கோல்` forms confirmed; no correction |
| 49 | PASS | unusual source period in `என்று இருந்தால்.` and all quoted text confirmed |
| 50 | PASS after correction | second quoted `திரும்பிப் பார்த்தான் அசோகன்` → source-visible `திருப்பிப் பார்த்தான் அசோகன்` |
...
| Scan | Result | Re-audit finding |
|---:|---|---|
| 116 | PASS after corrections | `ஆறுவகை ருசி நிறைந்த சாப்பாடு என்றுதான்` → source-visible `ஆறுவகை, ருசி நிறைந்த சாப்பாடு என்று தான்`; full page otherwise confirmed |
| 117 | PASS | complete text / unusual forms / punctuation / terminal `மறுபடியும்` confirmed |
| 118 | PASS | scan-117 continuation / complete text / punctuation / ending confirmed |
| 119 | PASS | complete text / quotation / punctuation / terminal `மாஜிஸ்` confirmed |
| 120 | PASS | scan-119 continuation / unusual quotation sequence / complete ending confirmed; scan 121 not opened |

Historical-family verification added **0 new correction events**; cumulative count remains **13**. Ordinary source-fidelity corrections — **2**.
...
| Scan | Result | Re-audit finding |
|---:|---|---|
| 131 | PASS | complete text / punctuation / terminal `அணு` confirmed |
| 132 | PASS | scan-131 continuation / dialogue punctuation / complete ending confirmed |
| 133 | PASS | complete text / five-line prison song / unusual number wording / ending confirmed |
| 134 | PASS | `C. P. பிளாக்` / quotation / complete long paragraph / ending confirmed |
| 135 | PASS | administrative list / source spacing / interruption sequence / ending confirmed; scan 136 not opened |

Historical-family verification added **0 new correction events**; cumulative count remains **14**. Ordinary source-fidelity corrections — **0**.
...
| Scan | Result | Re-audit finding |
|---:|---|---|
| 161 | PASS after corrections | two later `காண்விக்ட்` readings → source-visible `கான்விக்ட்`; rest of page / Roman parenthetical confirmed |
| 162 | PASS after corrections | `காண்விக்ட்` → `கான்விக்ட்`; `பெற்றவர்கள் தான்` → `பெற்றவர்கள்தான்`; `இருபதாண்டுகள் குள்ளாகவே` → `இருபதாண்டுகளுக்குள்ளாகவே`; `சிறு தூரத்தில்` → `சிறிது தூரத்தில்` |
| 163 | PASS after corrections | scan-162 continuation; `சொந்தவர்கள்` → `சேர்ந்தவர்கள்`; `காண்விக்ட்` → `கான்விக்ட்`; complete ending confirmed |
| 164 | PASS | complete text / quotations / unusual source forms / ending confirmed |
| 165 | PASS after corrections | `செலவழித்தும் -` → `செலவழித்தும்-`; `கண் துடைப்பு` → `கண்துடைப்பு`; ending confirmed; scan 166 not opened |

Historical-family verification added **0 new correction events**; cumulative count remains **19**. The `காண்விக்ட்` → `கான்விக்ட்` repairs are ordinary source-character corrections, not tracked reform-family events. Ordinary source-fidelity corrections — **10**.
...
Corrected post-audit state after explicit recheck of two line-wrap readings.

| Scan | Result | Re-audit finding |
|---:|---|---|
| 166 | PASS after correction | `அரசாங்கத் திடம்` → source-correct `அரசாங்கத்திடம்`; source wraps one lexical word as `அரசாங்கத்` + `திடம்` |
...
| 173 | PASS | source-correct `அவர்களை அக்பர்` retained; source wraps `அவர்` + `களை`; open quotation at page end confirmed |
...
Historical-family verification added **0 new correction events**; cumulative count remains **19**. Ordinary source-fidelity corrections — **1**.
