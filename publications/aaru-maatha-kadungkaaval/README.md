...
**Do not use attachment preview/parser output as source authority for page count, page structure, or P1 mapping.**

The previously recorded 150-page preview-derived P1 reconnaissance has been withdrawn.

For this publication, P0/P1 must be based on direct inspection of the **actual uploaded PDF bytes / physical PDF structure**.
...
This 1953 edition uses older Tamil typeforms. All later transcription must follow:
