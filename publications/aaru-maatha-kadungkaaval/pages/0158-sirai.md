...
- physical scan **158** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **9**.
- visible printed folio — **155**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **9** = original physical scan **158**.
...
- running header and continuous body text are directly visible; the page continues the prison-cap/classification discussion, but exact wording remains held.
