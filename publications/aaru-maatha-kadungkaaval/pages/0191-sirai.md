...
- physical scan **191** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **42**.
- visible printed folio — **188**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **42** = original physical scan **191**.
