...
- physical scan **173** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **24**.
- visible printed folio — **170**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **24** = original physical scan **173**.
