...
- visible printed folio — **113**.
- running header — `ஆறுமாதக் கடுங்காவல்`.
- source-visible forms including `கேள்விப்பட்டிருப்பீர்கள்-`, `சுவை அறுந்துபோன`, `சோராமல் சுயேச்சையாக`, `சுழலுதண்ணே`, `அடிவயிற்றிலேயிருந்து`, and `இருக்கமுடியவில்லை` were preserved.
- line-wrapped source words were joined only where the same printed word continues across the next line.
- page ends with complete `நாலு நாலுபேராக!`
...
**verified** — scan 116 was fully compared with source pixels.
