...
- physical scan **193** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **44**.
- visible printed folio — **190**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **44** = original physical scan **193**.
