...
- physical scan **178** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **29**.
- visible printed folio — **175**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **29** = original physical scan **178**.
