...
- visible printed folio — **82**.
- running header — `கருணாநிதி`.
- source-visible slogans and their quotation punctuation were preserved.
- source-visible `கண்களுக் குத்தியிருக்கும்`, `இழிவுநிறை`, `பலகை இளித்தபடி`, and `பிறந்த பொன் நாட்டின் உதிரம்` were preserved without contextual correction.
- page ends at physical continuation `மாணிக்க`; scan 86 was intentionally not opened.
...
**verified** — scan 85 was fully compared with source pixels.
