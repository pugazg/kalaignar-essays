...
- physical scan **181** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **32**.
- visible printed folio — **178**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **32** = original physical scan **181**.
