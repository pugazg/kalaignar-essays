...
- visible printed folio — **77**.
- running header — `ஆறுமாதக் கடுங்காவல்`.
- source-visible `புகைந்து போய்விடும்`, `ஒக்கு யாரும்`, `பொன்னிக் மொழிகள்`, and `ஊராள வந்தவர்!` were preserved without contextual correction.
- page ends in an open continuation at `கலந்துகொள்ளவேண்டிய`; scan 81 was intentionally not opened.
...
**verified** — scan 80 was fully compared with source pixels.
