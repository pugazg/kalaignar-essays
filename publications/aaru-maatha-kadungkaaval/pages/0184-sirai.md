...
- physical scan **184** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **35**.
- visible printed folio — **181**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **35** = original physical scan **184**.
