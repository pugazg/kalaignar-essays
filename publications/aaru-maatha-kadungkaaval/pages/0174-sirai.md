...
- physical scan **174** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **25**.
- visible printed folio — **171**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **25** = original physical scan **174**.
