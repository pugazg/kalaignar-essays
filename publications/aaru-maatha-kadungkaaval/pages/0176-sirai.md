...
- physical scan **176** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **27**.
- visible printed folio — **173**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **27** = original physical scan **176**.
