...
- source-visible forms including `பதினேழுகோடி`, `செலவும்-`, `செலவழித்தும்-`, `எங்குபோய்`, `அதுவுமில்லை;`, `அய்யோ• பாவம்`, `பிய்த்தெறியப்பட்டுக்கொண்டே யிருக்கிறது`, `பெறுதீர்கள்`, `குடிசைத்தொழில்`, `லட்சணத்திலே யிருக்கிறது`, and `கண்துடைப்பு` were preserved without normalization.
...
- every printed word, quotation mark, punctuation mark, meaningful spacing, running header, visible folio and complete ending was rechecked directly from derivative extract page **16** / original physical scan **165**.
- direct source-spacing correction: `இவ்வளவு செலவழித்தும் - சட்டம்` → **`இவ்வளவு செலவழித்தும்- சட்டம்`**.
- direct source-spacing correction: `வரையிலே கண் துடைப்பு சட்டங்களால்` → **`வரையிலே கண்துடைப்பு சட்டங்களால்`**.
- source-visible forms including `பதினேழுகோடி`, `செலவும்-`, `அதுவுமில்லை;`, `அய்யோ• பாவம்`, `பிய்த்தெறியப்பட்டுக்கொண்டே யிருக்கிறது`, `பெறுதீர்கள்`, `குடிசைத்தொழில்`, `லட்சணத்திலே யிருக்கிறது`, and question mark after `அத்தாட்சி?` were otherwise reconfirmed.
- page ends with complete `மந்த புத்தியினருக்கு நினைவுறுத்துகிறது.`; **scan 166 / extract page 17 was not opened or processed in Batch R33**.
- paper toning / upper-left copy mark remain non-publication layer; no body wording is obscured.
- mandatory historical-family verification was repeated; `நிலைமை` (`லை`), `சிறைச்சாலையிலும்`, `நினைவுறுத்துகிறது` and the full 13-family set were checked by character identity.
