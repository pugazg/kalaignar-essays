...
- physical scan **197** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **48**.
- visible printed folio — **194**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **48** = original physical scan **197**.
