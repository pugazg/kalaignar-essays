...
- physical scan **157** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **8**.
- visible printed folio — **154**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **8** = original physical scan **157**.
...
- source visibly contains quoted classification terms including `“வெள்ளைக் குல்லாய்”` and `“கருப்புக் குல்லாய்”`, plus the Roman-script parenthetical `(Borstal School)`; these are recorded only as source landmarks, not as a substitute for full transcription.
