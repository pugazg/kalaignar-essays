...
- physical scan **170** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **21**.
- visible printed folio — **167**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **21** = original physical scan **170**.
