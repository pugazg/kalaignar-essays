...
- physical scan **182** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **33**.
- visible printed folio — **179**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **33** = original physical scan **182**.
