...
- visible printed folio — **110**.
- running header — `கருணாநிதி`.
- source-visible unusual forms including `போலீஸ்வண்டி`, `நலமின்றி யிருக்கிறார்`, `என் அப்போதே`, `கதர்ச்சட்டைக்காரர்`, and terminal `என் தான்` were preserved without contextual correction.
- page ends mid-thought at `எனக்கு நானே`; scan 114 begins `ஆச்சரியப்படுவேன்`.
...
**verified** — scan 113 was fully compared with source pixels.
