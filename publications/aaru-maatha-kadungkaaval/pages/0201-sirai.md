...
- visible printed folio — **198**.
- running header — `கருணாநிதி`.
- extract page **52** = physical scan **201**.
- page begins with the source-visible continuation fragment `யோர்`; no preceding letters were reconstructed from scan 200.
- page ends mid-sentence at `ஒரு கடிதம்`; no scan-202 wording was pulled backward.
...
**verified** — scan 201 was fully compared with source pixels.
