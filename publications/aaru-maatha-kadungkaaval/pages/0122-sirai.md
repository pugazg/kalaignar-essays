...
- visible printed folio — **119**.
- running header — `ஆறுமாதக் கடுங்காவல்`.
- source-visible forms including `படைவரிசை யென்ற`, `மூணுமாதம்`, `ஆறுமாதம்தான்`, `என் அப்படி?`, and `திட்டத்துடனே-என்னவோ` were preserved.
- ordinary line-wrap splits such as `மற்றவர் / களுக்கு` were joined as the same printed word.
- page ends with complete `எங்களை உட்கார வைத்துவிட்டனர்.`
...
**verified** — scan 122 was fully compared with source pixels.
