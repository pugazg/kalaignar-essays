...
- physical scan **192** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **43**.
- visible printed folio — **189**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **43** = original physical scan **192**.
