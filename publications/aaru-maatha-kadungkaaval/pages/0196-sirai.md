...
- physical scan **196** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **47**.
- visible printed folio — **193**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **47** = original physical scan **196**.
