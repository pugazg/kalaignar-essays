...
- physical scan **190** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **41**.
- visible printed folio — **187**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **41** = original physical scan **190**.
