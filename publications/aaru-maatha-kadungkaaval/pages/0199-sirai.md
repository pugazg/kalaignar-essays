...
- physical scan **199** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **50**.
- visible printed folio — **196**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **50** = original physical scan **199**.
