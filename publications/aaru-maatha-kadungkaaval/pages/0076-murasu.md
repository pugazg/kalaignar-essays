...
- visible printed folio — **73**.
- running header — `ஆறுமாதக் கடுங்காவல்`.
- source-visible `கிழப் பருவமும்`, `செய்திகேட்டு`, and `இளைஞர்கட்கும்-ஒளிப்பாதையைக்` were preserved.
- page ends at physical fragment `அவர்`; scan 77 begins `களிடத்திலே`, directly establishing the continuation `அவர்களிடத்திலே` without altering either page record.
...
**verified** — scan 76 was fully compared with source pixels.
