...
- physical scan **153** was opened directly from the user-supplied 75-page extract corresponding to original physical scans **150–224**.
- extract page — **4**.
- visible printed folio — **150**.
- P1 classification — **main text / `sirai`**.
- the supplied extract is a page-range derivative of the same controlling source, not an alternate edition; extract page 1 visibly duplicates original scan 150 / printed folio 147, establishing extract page 4 = physical scan 153.
