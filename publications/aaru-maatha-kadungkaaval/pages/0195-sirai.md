...
- physical scan **195** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **46**.
- visible printed folio — **192**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **46** = original physical scan **195**.
