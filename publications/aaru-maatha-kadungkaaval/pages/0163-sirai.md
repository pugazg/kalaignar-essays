...
- physical scan **163** was opened directly from the user-supplied 75-page extract covering original physical scans **150–224**.
- extract page — **14**.
- visible printed folio — **160**.
- P1 classification — **main text / `sirai`**.
- stable mapping — extract page **14** = original physical scan **163**.
