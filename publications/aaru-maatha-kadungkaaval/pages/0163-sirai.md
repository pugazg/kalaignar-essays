...
- paper toning / age specks and isolated dark dots are not publication text.
...
- representative sensitive clusters including `காணுமுன்னே`, `நன்றாகப்`, `நிலை`, `வாலிபத்தைக்`, and `மரண` were checked by character identity.
...
**verified** — scan 163 placeholder was replaced only after full direct source-pixel transcription and audit.
