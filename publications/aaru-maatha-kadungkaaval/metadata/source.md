...
## P2 source use through scan 200

Canonical records exist for scans **1–200**.
...
- post-batch enlarged-pixel recheck corrected source readings in all five canonical records without changing status counts.
- scan 96 `சிஷ்யனை` → scan 97 `யும் தாக்கட்டும்’` continuation was confirmed directly.
- scan 97 difficult personal name is source-resolved as `தருமு`: `தருமுவும்` / `தருமு முதலியோரை`.
...
- scans 181–185 — exact transcription / punctuation / physical-copy-mark audit / historical-glyph verification pending focused archival-fidelity re-read;
- scans 186–190 — exact transcription / punctuation / physical-copy-mark audit / historical-glyph verification pending focused archival-fidelity re-read;
- scans 191–195 — exact transcription / punctuation / physical-copy-mark audit / historical-glyph verification pending focused archival-fidelity re-read;
- scans 196–200 — exact transcription / punctuation / physical-copy-mark audit / historical-glyph verification pending focused archival-fidelity re-read.
