...
- preserve direct address, accusation, sarcasm, ridicule, questions, commands, repetition and exclamation;
- retain source-bearing ideological vocabulary and source-chosen names/epithets;
- preserve quotation status and source-page comments;
- do not insert explanatory historical claims into body text;
- retain unexplained source-specific labels/transliterations when the source does not support an expansion;
- keep the scan-40 printer witness outside Unit-6 English prose.

## Article gates

Each article must pass T0 source pin → T1 close draft → T2 bilingual fidelity → T3 voice → T4 terminology/quotation/citation → T5 verification.
...
Article 3 T4 verified its sacrifice/altar motif, `உயிர்ப்பலி / வாழ்வு` contrast, **Bharat Mata**, **Gora Kumbhar**, `class hatred`, `northern language`, `technical vocabulary`, `original inhabitants`, `growth of the race` and `sacrifice of the race`, while retaining source labels and all six page comments.

## Exact next activity

Proceed with **Article 4 — `விழலுக்கு நீர் இறைத்து...` — T0 source-pin confirmation followed by T1 complete English draft**, using only frozen Tamil blob `91f764f73c9514b2ce1eefdd94d3a1320a0c228e`. The working title **Watering the Weeds...** remains image-sensitive and must be reviewed in article context before T4 verification. Preserve verified Articles 1–3.
