...
- The opening `டோம்` continues the page-ending fragment `தரணியாண்` on scan 29.
- The damaged reading `இதுதானா` is preserved from the user's manual review.
- Source-visible forms `சழக்கர்கள்`, `தூண்டுதலைக்`, and `சூரர்களின் பணி மனைகளில்` are retained without normalization.
