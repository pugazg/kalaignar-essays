...
- The damaged reading `புயலெனச்` is preserved from the user's manual review.
- Source-visible punctuation, repeated ellipses, and the page-ending fragment `தரணியாண்` are retained; scan 30 begins with its continuation.
