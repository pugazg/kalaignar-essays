...
| `இந்துஸ்தான்` | Hindustan | Preserve source-chosen political/geographical label. | A1 T1 | **verified A1 T4** |
| `சிசுஹத்தி` | infanticide | Preserve harsh source term and infant metaphor. | A1 T1 | **verified A1 T4** |
| `அணுகுண்டு` | atom bomb | Period wording. | A1 T1 | **verified A1 T4** |
| `சன்மார்க்க மதம்` | religion of righteousness | Preserve moral/religious rhetorical label. | A1 T3 | **verified A1 T4** |
...
| `கோத்திரம்` | gotra | Source-bearing social term. | A2 T1 | **verified A2 T4** |
| `துளசிமணி மாலை` | tulasi-bead garland | Preserve material/religious image. | A2 T1 | **verified A2 T4** |
| `தர்ப்பை` | darbha grass | Source-bearing ritual term. | A2 T1 | **verified A2 T4** |
| `கமண்டலம்` | kamandalu | Source-bearing ritual object. | A2 T1 | **verified A2 T4** |
| `குய்யோ முறையோ` | Kuyyo! Muraiyo! | Retain source-bearing lament rather than inventing an external identification. | A2 T1 | **verified A2 T4** |
| `நீலிக் கண்ணீர்` | Neeli tears | Retain source-bearing expression; no unsupported explanatory identification inserted. | A2 T1 | **verified A2 T4** |
| `விபீஷணர்கள்` | Vibhishanas | Retain source-bearing literary/polemical label without body-text expansion. | A2 T1 | **verified A2 T4** |
| `வெங்கண்ணா` | Venganna | Retain unexplained source-bearing name/expression; do not guess its identification. | A2 T1 | **verified A2 T4** |
...
| `இன வளர்ச்சி` | growth of the race | Preserve publication use of `இனம்` rather than neutralising to generic “development”. | A3 T1 | **verified A3 T4** |
| `இனப்பலி` | sacrifice of the race | Closing Article-3 refrain; preserve the sacrifice/race compound. | A3 T1 | **verified A3 T4** |
| `பார்ப்பனர் ஒழிக` | Down with Brahmins | Preserve slogan form; surrounding paragraph explicitly distinguishes this from the author's demand. | A3 T1 | **verified A3 T4** |
| `அர்ச்சனை` | archana | Source-bearing ritual term. | A3 T1 | **verified A3 T4** |
...
| `சூத்திரர்` | Shudras | Article 5 opening quotation; preserve the caste-bearing source term without euphemism. | A5 T1 | **verified A5 T4** |
| `மத நடுநிலைமை` | religious neutrality | Preserve the source's quoted political/legal label. | A5 T1 | **verified A5 T4** |
| `அடக்குமுறைக் கணைகள்` | arrows of repression | Preserve the repeated missile image across bans, gags and prosecutions. | A5 T1 | **verified A5 T4** |
| `வெத்து வேட்டு` | blank shots | Article 5 contrasts apparently harmless shots with a warning shot to Dravidians. | A5 T1 | **verified A5 T4** |
| `போலீஸ் தர்பார்` | police darbar | Retain source-bearing `darbar` rather than flattening the contemptuous image into neutral administration. | A5 T1 | **verified A5 T4** |
| `இன எழுச்சி` | awakening of the race | Preserve publication use of `இனம்` and the movement-rhetorical force. | A5 T1 | **verified A5 T4** |
| `சந்தர்ப்பபேத` | divisions created according to circumstance | Source-close rendering in the conspiracy-letter passage; avoids the more interpretive T1 wording **manufactured to suit the occasion** and does not add an external identification. | A5 T1 / T2 | **verified A5 T4** |
...
- Do not silently replace source labels with modern full names.
- Conventional English spellings may be used for well-established names, but source distinctions must not be erased.
