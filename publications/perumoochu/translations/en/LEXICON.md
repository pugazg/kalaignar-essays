# English Living Lexicon — பெருமூச்சு
...
| `அஹிம்சா` | **ahimsa** | Source-bearing political/religious term; Article 7 title treatment remains open until title audit. | repository house style / E0 | provisional source-bearing |
| `சுயமரியாதை` | **self-respect** | Preserve movement/reform force; do not soften to generic dignity if the source is ideological. | E0 | provisional / contextual |
| `திருக்குறள்` | **Tirukkural** | Preserve work title. | repository house style / E0 | provisional |
| `சிலப்பதிகாரம்` | **Silappathikaram** | Preserve work title; do not import a published English translation. | repository house style / E0 | provisional |
| `கோவலன்` | **Kovalan** | Source literary name and Article 11 electoral analogy. | E0 | provisional source-bearing |
...
- preserve direct address, questions, commands, exclamations, mock praise, sarcasm and accusatory cadence;
- preserve source quotation scope; do not turn quoted political speech into indirect narration;
- Article 7 — preserve the quoted-title framing of `“அஹிம்சா விலாசம்”`;
- Article 11 — translate the Silappathikaram/Kovalan analogy from the frozen source without importing outside literary explanation;
