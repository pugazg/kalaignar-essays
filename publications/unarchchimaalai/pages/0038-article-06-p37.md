...
- Gemini word tokens are retained, including `இழத்துக்`, `பிர பிரஹலாதர்களாக`, `வேண்டியுளது`, and other non-normalised forms.
- OCR line-wrap spaces such as `துரை சாமி`, `தேவை யாயிருக்கிறது`, `கருது கிறார்`, `சமு தாயத்தின்`, `ஒரியண் டல்`, `கொள் ளுங்கள்`, `பெரி யோரே`, and `மீண் டும்` were joined as authorised spacing corrections only.
