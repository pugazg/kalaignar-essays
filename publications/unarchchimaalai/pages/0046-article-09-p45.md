...
- Gemini lexical baseline is retained; P5 changes are source-supported punctuation/spacing only.
- OCR line-wrap spaces were joined without lexical substitution except where the source-visible spacing itself is the P5 target.
