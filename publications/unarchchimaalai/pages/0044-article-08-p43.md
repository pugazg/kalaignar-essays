...
- Gemini lexical forms including `பன் முறை`, `குழந்தைகளப்பா`, `கலயத்தில்`, and `ஓருருவாகிப்` are retained.
- P5 lexical conflict retained: Gemini `ஓருருவாகிப்`; scan appears to print `ஒருருவாகிப்`.
- Gemini artefact `e` remains excluded because no such printed text appears.
