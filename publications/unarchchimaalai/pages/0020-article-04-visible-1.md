...
transcription_method: "Gemini lexical baseline retained; punctuation, paragraphing and page-number witness checked directly against source scan"
---
...
- Aged paper, left-edge wear/tears and small physical-copy marks are visible; none is merged into the printed text.

## Audit note

- The Gemini lexical baseline begins Article 4 on this scan; its word tokens are retained.
- Source-supported line-wrap spaces were joined and punctuation/quotation marks were restored without changing letters.
- At the printed-page-number position only a single visible `1` is legible. `printed_page` therefore records only `1`; **no unseen `19` is reconstructed**.
- The last phrase continues directly onto scan 21.

<!-- மூல ஸ்கேன் பக்கம்: 20; அச்சுப் பக்கம்: visible `1` only -->