...
transcription_method: "Gemini lexical baseline retained; heading, paragraphing and quotation punctuation checked directly against source scan"
---
...
- Aged paper and minor surface marks are visible.

## Audit note

- Article heading `அன்னை நாகம்மையார்!` is source-visible; no printed page numeral is visible on this opening scan.
- Gemini word choices are retained, including `தளும்பும்` and the source-pass wording around `மைனர்- காலி`.
- OCR line-wrap spaces were joined as spacing corrections only.

<!-- மூல ஸ்கேன் பக்கம்: 45; அச்சுப் பக்கம்: — -->