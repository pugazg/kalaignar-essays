...
- Article 9 final English: `204ffed012f4bd91b3077065f031d6b2db747854`
...
## Article 9 — T0–T5 COMPLETE / VERIFIED
...
- source labels `Periyar`, `Ramasami`, `Nagammaiyar` / `Nagamma`, `Ramasamiyar`, `Ammaiyar`: **T5 VERIFIED / no outside conventionalisation**.
- `minor-kaali`, quoted `log` image, youthful vow, Nagamma's marriage-or-death declaration, horse/stable revolutionary quotation and family-lamp declaration: **T5 PASS**.
- all ages/dates/numbers `19`, `13`, `1898`, `35`, `1933`, `11-5-1933`, `12-5-1933`, `144`: **T5 PASS**.
- all source-page comments and printed witnesses: **T5 PASS**.
- public-service/self-interest contrast, flood-with-flood image, repeated `many! many!`, never-drying life-river, affectionate old-man/Nagammaiyar exchange and final `காதலையும் மீறிய கடமை` sentence: **T5 PASS**.
