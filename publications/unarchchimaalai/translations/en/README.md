...
Articles 1–8 have completed T0–T5 and are individually `verified`. Article 9 has completed T1–T2 and is `fidelity-reviewed`; T3 has not started.
...
| 9 | அன்னை நாகம்மையார்! | [`09-annai-nagammaiyar.md`](09-annai-nagammaiyar.md) | `fidelity-reviewed` | PASS | PASS | **PASS** | — | — | — |
...
- youthful marriage vows, the quoted `log` image, horse/stable revolutionary verse, Ramasami's family-lamp declaration, old-man/Nagammaiyar exchange, affection, ridicule and polemical imagery: **T2 PASS**.
