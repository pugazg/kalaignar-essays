...
- address: `6, மங்கம்மாள் தெரு, (மின்ட் போஸ்ட்)-சென்னை-1`
- two rectangular library stamps are physical-copy evidence and are not merged into printed text
...
## Publication type / boundaries

Standalone single-article pamphlet / சிறுநூல்:
...
- blank: scan **5**
- article: scans **6–15**
- article conclusion: scan **15**
- advertisements / promotional matter: scans **16–17**

## Printed-page numbering

- scans 1–5: no visible printed page number
- scan 6: **no visible printed numeral**; no invented page 5
- scans 7–15: printed pages **6–14**
- scans 16–17: no visible printed page number

## Scan / physical-copy observations

- source is image-only; no authoritative embedded text layer
- aged paper tone, speckling, stains and reverse-side bleed-through occur
- scan 1: hanging-human silhouette cover artwork
- scan 2: two rectangular library stamps; obscured/crossed wording is not reconstructed
- scan 15: library stamp below printed ending ornament
- scans 16–17: independent printed promotional witnesses
