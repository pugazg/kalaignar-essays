...
Fetch live `main` first and preserve newer durable work. Root `HANDOVER.md` is the **single authoritative project handover**. This prompt is only a continuation convenience.
